...
from pointComNet.topnet.topnet import TopNetModel as Net_model
...
def main(args):
    ...
    yaml_file = os.path.join(os.path.dirname(__file__), "../config/topnet.yaml")
    ...
    ae_model = Net_model(parameter=parameters,
                         ...
                         logger_file_name=os.path.join(log_dir, "topnet_" + args.logfilename),
