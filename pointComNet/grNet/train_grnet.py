...
from pointComNet.grNet.grnet import GRNetModel as Net_model
...
def main(args):
    ...
    yaml_file = os.path.join(os.path.dirname(__file__), "../config/grNet.yaml")
    ...
    ae_model = Net_model(parameter=parameters,
                         ...
                         logger_file_name=os.path.join(log_dir, "grnet_" + args.logfilename),
