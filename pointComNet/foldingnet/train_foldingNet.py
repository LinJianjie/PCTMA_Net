...
from pointComNet.foldingnet.foldingNet_model import FoldNetModel as Net_model
...
def main(args):
    ...
    yaml_file = os.path.join(os.path.dirname(__file__), "../config/foldnet.yaml")
    ...
    ae_model = Net_model(parameter=parameters,
                         ...
                         logger_file_name=os.path.join(log_dir, "foldnet_" + args.logfilename),
